'use strict';
// Staff powers come from the openvibe-contracts staff map (ADR-022): staff.site.configure makes a person Codes staff (CODES_STAFF_SUBJECTS names more).
...
// Not staff: reading the role claim for display, and a project's own roles (owner/admin/developer/viewer).
const ALLOW = [['server/auth/sso.js', "typeof claims.role === 'string'"], ['server/http/portal.js', "const assignable = role === 'owner'"]];
const offenders = [];
(function walk(dir) {
