 ...
 *   - the shared chrome: navbar.js and theme-loader.js from the Network (progressive), a <noscript>
...
${chrome.noscriptNav({ name: SITE_NAME, home: '/', links: NAV })}
<div class="account-bar" role="navigation" aria-label="Account">${render(account)}</div>
<main id="main" class="page">
${render(crumbs)}
${render(o.body)}
</main>
${chrome.footer({ service: 'codes', variant: 'full' })}
<script>
